...
model.add(LSTM(128, dropout=rate_drop_lstm, recurrent_dropout=rate_drop_lstm, return_sequences=True))
model.add(SeqSelfAttention(attention_type='multiplicative',attention_activation='sigmoid'))
model.add(LSTM(32, dropout=rate_drop_lstm, recurrent_dropout=rate_drop_lstm, return_sequences=True))
model.add(SeqSelfAttention(attention_type='multiplicative',attention_activation='sigmoid'))
model.add(LSTM(8, dropout=rate_drop_lstm, recurrent_dropout=rate_drop_lstm, return_sequences=False))
